...
- Current validation-system line counts: `Program.cs` is a tiny entry point, `ReviewGateRegistry.cs` is under 40 lines. ReviewGate runner current source budget: 9 C# source files / 568 total lines; largest C# file tools/ReviewGate/ReviewGateEvidence.cs has 148 lines.
- Current all-tools suite budget lock: Validation tool suites current source budget: 149 C# source files / 19694 total lines across 55 suites; largest C# file tools/CombatBehaviorSkirmish/SkirmishAi.cs has 393 lines; largest suite tools/ReviewGateRuntime has 1000 lines.
