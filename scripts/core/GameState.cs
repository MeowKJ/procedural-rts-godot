...
public sealed partial class GameState
{
    ...
    private readonly List<UnitModel> _legacySelectedCommandUnits = [];
    private readonly List<FormationUnit> _legacyMoveFormationUnits = [];
    private readonly List<FormationDestination> _legacyMoveDestinationResults = [];
    private readonly Dictionary<int, FormationDestination> _legacyMoveDestinations = [];
    private readonly List<FormationUnit> _legacyMoveOrderedUnits = [];
    private readonly List<(float X, float Y)> _legacyMoveSlots = [];
    private readonly List<(float X, float Y)> _legacyMoveRemainingSlots = [];
    ...
    private readonly List<int> _legacySelectedUnitIds = [];
