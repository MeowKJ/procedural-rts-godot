...
public partial class HudLayer : CanvasLayer
{
    ...
    private void BuildCommandRibbon(Control root)
    {
        ...
        _targetingContextValue = MakeSizedLabel(GameText.T("command.target.none"), new Vector2(424, 9), new Vector2(190, 28), FontTiny, InkMuted);
        _targetingContextValue.Name = "RibbonTargetingContext";
        _targetingContextValue.HorizontalAlignment = HorizontalAlignment.Center;
        _commandRibbon.AddChild(_targetingContextValue);
