...
public partial class HudLayer : CanvasLayer
{
    ...
    private void BuildRightDrawer(Control root)
    {
        ...
        AddCatalogModeButton(_rightProductionPanel, CatalogModeKind.Train, GameText.T("ui.catalog.train"), GameText.T("ui.catalog.trainDetail"), new Vector2(106, 8));
        AddCatalogModeButton(_rightProductionPanel, CatalogModeKind.Abilities, GameText.T("ui.catalog.abilities"), GameText.T("ui.catalog.abilitiesDetail"), new Vector2(200, 8));
