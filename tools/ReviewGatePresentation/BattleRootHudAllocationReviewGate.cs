static class BattleRootHudAllocationReviewGate
{
    public static void Check(string root, GateResult result)
    {
        ...
        RequireText(englishText, "[\"ui.catalog.overview.upgrades\"] = \"{0} projects | source req\"", "English catalog mode Upgrades overview must stay a selected-source shell.", result);
