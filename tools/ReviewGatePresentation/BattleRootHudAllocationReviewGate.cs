static class BattleRootHudAllocationReviewGate
{
    public static void Check(string root, GateResult result)
    {
        ...
        RequireText(ReviewGateSource.Read(root, "scripts", "core", "units", "runtime", "battlefield", "construction", "UnitBattlefield.BuildingSell.cs"), "BuildSpecCatalog.For(identity.Kind)", "Selected building sell must refund from the build spec instead of production cancel constants.", result);
