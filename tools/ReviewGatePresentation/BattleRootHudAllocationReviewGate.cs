static class BattleRootHudAllocationReviewGate
{
    public static void Check(string root, GateResult result)
    {
        ...
        RequireText(hudLayer, "Action<string>? BuildKindRequested", "HudLayer must expose a build-kind catalog intent for build option cards.", result);
        ...
        RequireText(ReviewGateSource.Read(root, "scripts", "controllers", "BuildPlacementController.cs"), "public bool SelectBuildKind(string kind)", "Build placement controller must expose a specific build-kind entry point for catalog cards.", result);
        ...
        RequireText(hudLayer, "BuildKindRequested?.Invoke(button.BuildKind)", "Build option cards must emit build-kind intents instead of production requests.", result);
