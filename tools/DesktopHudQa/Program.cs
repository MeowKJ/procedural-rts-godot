...
static void AssertHudFactoryExtraction(string root)
{
    ...
    RequireText(englishText, "[\"ui.catalog.overview.upgrades\"] = \"{0} projects | source req\"", "English HUD catalog Upgrades overview must stay a selected-source shell.");
    ...
    RequireText(chineseText, "[\"ui.catalog.overview.upgrades\"] = \"{0}项目 | 需来源\"", "Chinese HUD catalog Upgrades overview must stay a selected-source shell.");
