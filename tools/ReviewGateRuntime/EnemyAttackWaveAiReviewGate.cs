static class EnemyAttackWaveAiReviewGate
{
    ...
    private static void RequireTargetScanLoops(string root, GateResult result)
    {
        ...
        var unitBattlefieldTargetQueries = ReviewGateSource.Read(root, "scripts", "core", "units", "runtime", "battlefield", "query", "UnitBattlefield.AttackTargetQueries.cs"); var unitBattlefieldGeometryQueries = ReviewGateSource.Read(root, "scripts", "core", "units", "runtime", "battlefield", "query", "UnitBattlefield.AttackWaveGeometryQueries.cs");
