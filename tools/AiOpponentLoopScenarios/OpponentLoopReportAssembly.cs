...
internal static partial class AiOpponentLoopQaProgram
{
        ...
        TournamentStateFailure? stateFailure)
    {
        ...
        return new OpponentLoopReport(
            ...
            HarvestAppliedCommands: metrics.HarvestAppliedCommands,
            ConstructionAppliedCommands: metrics.ConstructionAppliedCommands,
            ProductionAppliedCommands: metrics.ProductionAppliedCommands,
            WaveAppliedCommands: metrics.WaveAppliedCommands,
