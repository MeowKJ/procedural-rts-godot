...
Console.WriteLine($"CursorCatalogQa PASSED: {BattleCursorCatalog.Definitions.Length} cursor states, hotspot bounds, preview mapping, and build valid/invalid hotspot parity.");
