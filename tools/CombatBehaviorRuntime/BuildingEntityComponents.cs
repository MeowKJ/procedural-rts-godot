static partial class Program
{
    private static void AssertBuildingEntityComponents()
    {
        ...
        var hqEntity = buildingEntityWorld.SpawnBuildingTarget(hqTarget, hqBuildSpec);
        hqEntity.Components.Set(hqEntity.Components.Require<WeaponUserComponentState>() with
        {
            Mounts = new[] { new WeaponMountRuntimeState("main", hqBuildSpec.WeaponId!, hqTarget.Facing, 0.4f) },
        ...
        var refineryBuildSpec = BuildSpecCatalog.For(BuildingDesignIds.Refinery);
        ...
        changedBarracksEntity.SpawnBuildingTarget(hqTarget, hqBuildSpec);
        ...
        changedBarracksEntity.SpawnBuildingTarget(refineryTarget, refineryBuildSpec);
        ...
        if (hqEntitySpec.Kind != EntityKind.Turret
            || hqEntitySpec.Stats?.Cost != hqBuildSpec.Cost
            ...
            || hqTargetSpec.MaxHp != hqBuildSpec.MaxHp
            || hqTargetSpec.Footprint != hqBuildSpec.Footprint
            || hqTargetSpec.ArmorTag != hqBuildSpec.ArmorTag
            || hqTargetSpec.WeaponId != hqBuildSpec.WeaponId
        ...
        {
            throw new InvalidOperationException("BuildSpecCatalog building targets should routing into entity specs/components for turrets, producers, construction, power, docks, projected dock delivery pulses, and deterministic hashes");
        }
    }
}
